...
//Code Here
let totalPopulation = populations.reduce(function(val, element) {
  return val + element;
})
...
//Code Here
function filterCP(monster){
  if (monster.CP > 200){
    return true
  }
}
let myStrongest = monstersInYourPocket.filter(filterCP)
...
let bobsTotal = purchases.reduce(function(subtotal,current) {
